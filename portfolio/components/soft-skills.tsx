  ...
  return (
    <section id="soft-skills" className="py-20 bg-[#FFFBE6]">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center text-[#333333] mb-12">Soft Skills</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {softSkills.map((skill) => (
            <div key={skill.name} className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-semibold text-[#333333] mb-2">{skill.name}</h3>
              <p className="text-[#666666]">{skill.description}</p>
            </div>
          ))}
        </div>
      </div>
